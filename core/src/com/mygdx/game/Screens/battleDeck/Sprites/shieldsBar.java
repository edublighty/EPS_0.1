...
public class shieldsBar extends Sprite {

    public World world;
    public Body b2body;
    private TextureRegion room;

    public shieldsBar(World world, battleShipScreen screen, List<Float> tempSize, String iconType) {
    ...
    public void defineSprite(List<Float> tempSize) {
        ...
        //shape.set(Math.round(tempSize.get(2)),Math.round(tempSize.get(3)),Math.round(tempSize.get(0)),Math.round(tempSize.get(1)));
