...
public class planetSpriteGRAVY extends Sprite {
    ...
    public planetSpriteGRAVY(World world, systemScreen2 screen, String stelObj, double planetData[][], int i, int wWid, int wHei) {
