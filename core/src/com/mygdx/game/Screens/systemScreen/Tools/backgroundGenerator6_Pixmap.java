...
public class backgroundGenerator6_Pixmap {

    private BufferedImage img;
    private Pixmap pixmap;
    private MyGdxGame game;

    public backgroundGenerator6_Pixmap(MyGdxGame game) {
        ...
        for(int i=0;i<width;i++){
            for(int j=0;j<height;j++){
                ...
                float a1 = ((pixel >> 24) & 0xff);//*1f/255;
                float a = a1/255;
                float r = ((pixel >> 16) & 0xff)*1f/255;
                float g = ((pixel >> 8) & 0xff)*1f/255;
                float b = ((pixel) & 0xff)*1f/255;
