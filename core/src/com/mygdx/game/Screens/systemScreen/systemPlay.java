...
/**
 * Created by GCUser on 10/05/2018.
 */

public class systemPlay implements Screen {
    ...
    public systemPlay(MyGdxGame game){
        ...
        while(i<nP) {
            ...
            float a = orbline[i].getWidth();
            float b = orbline[i].getHeight();
        ...
        maxZoomX = maxZoomX*1.25f;
        maxZoomY = maxZoomY*1.25f;
