...
public class systemHealthBars extends Image {
    ...
    public systemHealthBars(systemScreen2 screen, float width, float height, float Xcoord, float Ycoord){
        super(screen.getHealthAt().findRegion("healthBar100"));
