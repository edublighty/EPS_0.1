...
public class systemGauge extends Image {
    ...
    public systemGauge(systemScreen2 screen, float width, float height, float Xcoord, float Ycoord){
        super(screen.getThrustAt().findRegion("playerGauge2"));
