...
public class systemControlHandle extends Image {
    ...
    public systemControlHandle(systemScreen2 screen, float width, float height, float Xcoord, float Ycoord){
        super(screen.getThrustAt().findRegion("thrust handle2"));
        this.screen = screen;
        setWidth(width);
        setHeight(height);
        setX(Xcoord);
