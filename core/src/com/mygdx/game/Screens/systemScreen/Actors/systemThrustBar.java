...
public class systemThrustBar extends Image {
    ...
    public systemThrustBar(systemScreen2 screen, float width, float height, float Xcoord, float Ycoord){
        super(screen.getThrustAt().findRegion("thrustSelector"));
